...
namespace BTree
{
    public partial class Form1 : Form
    {
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            node = new BTree(rand.Next(1, 52), null);
            root = node;
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            node = new BTree("FREEZE", null);
            root = node;
            node = new BTree("COLD", root);
            node = new BTree("BLIZZARD", root);
            node = new BTree("AIR", root);
            node = new BTree("EASTER", root);
            node = new BTree("DINOSAUR", root);
            node = new BTree("JOB", root);
            node = new BTree("INDEX", root);
            node = new BTree("HOME", root);
            node = new BTree("GREEN", root);
            node = new BTree("LOOP", root);
            node = new BTree("KIND", root);
            node = new BTree("POEM", root);
            node = new BTree("OPEN", root);
            node = new BTree("NINTENDO", root);
