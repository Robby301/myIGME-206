...
namespace NumberSort
{
    class Program
    {
        ...
        start:
            Console.WriteLine("Enter a sentence, making sure each set of words has a space inbetween them");
            ...
            foreach (string sThisWord in sSentenceWords)
            {
                ...
                //The next line of code isn't needed
        ...
        static void RemoveUnsortedValue(string removeValue, ref string[] array)
        {
            ...
            foreach (string srcWord in array)
            {
                ...
                if (srcWord.Equals(removeValue) && !bAlreadyRemoved)
                {
