...
class Program
{
    ...
    static void Main()
    {
        ...
        // this is used to initialize the timeout flag
        timeOut = false;
    ...
    start:
        ...
        for( nCntr = 0; nCntr < nQuestions; ++nCntr )
        {
            ...
            do
            {
                ...
                ElapsedEvenHandler elapsedEventHandler;

                elapsedEventHandler = new ElapsedEvenHandler(TimesUp);
            ...
            else if (timeOut)
            {
                ...
                Console.WriteLine("I'm sorry, but you ran out of time for the question");
            }
            else
            {
                Console.BackgroundColor = ConsoleColor.Black;
